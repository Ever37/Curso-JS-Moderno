...
function buscarImagenes() {
  ...
  const key = '22544996-b58c60755c7a7971c375384b5';
              ...
              <div class="bg-white ">
                  ...
                  <div class="p-4">
                      ...
                      <a href=${largeImageURL} 
                        ...
                        target="_blank" class="bg-blue-800 w-full p-1 block mt-5 rounded text-center font-bold uppercase hover:bg-blue-500 text-white">Ver Imagen
                      </a>
                  </div>
              </div>
          </div>
